mainApp.controller("reportRiwayatKlaimCtrl", function ($scope, $routeParams, $q, Excel, $timeout, $cookies, $filter, Constant, HttpRequest, Model, Helper, Upload) {
    ...
    $scope.searchByDate = function (startDate, endDate) {
        ...
        // // console.log(endDate);
        var apiUrl = "/report/" + $scope.currentUser.email + "/" + $scope.tglAwal + "/" + $scope.tglAkhir + "/getKlaimByTanggal";
        console.log(apiUrl);
    ...
    $scope.exportToExcel = function (tableId) { // ex: '#my-table'
        var exportHref = Excel.tableToExcel(tableId, 'Report Riwayat Klaim');
        $timeout(function () {
