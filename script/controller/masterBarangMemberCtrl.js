mainApp.controller("masterBarangMemberCtrl", function ($route, $scope, $http, $uibModal, $routeParams, $q, $cookies, Constant, HttpRequest, Model, Helper, DTOptionsBuilder, DTColumnBuilder, markers, Upload, $timeout) {
    //Variable
    ...
    $scope.renderListData = function () {
        $('.Loading').show();
        $('.page-form').hide();
        var apiUrl = "/member/" + $scope.currentUser.email + "/getBarangMember";
