mainApp.controller("reportBarangMemberCtrl", function ($scope, $routeParams, $q, Excel, $timeout, $cookies, $filter, Constant, HttpRequest, Model, Helper, Upload) {
    $scope.Helper = Helper;
    $scope.currentUser = {};
    ...
    $scope.renderList = function () {
        var apiUrl = "/report/" + $scope.currentUser.email + "/getListBarangMember";
        console.log(apiUrl);
