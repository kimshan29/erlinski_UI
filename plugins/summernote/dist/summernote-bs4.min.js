    ...
    var X = function(a) {
        ...
        ca = function(b) {
            var c = this,
                ...
                i = this.representShortcut = function(a) {
                    var b = h[a];
                    return f.shortcuts && b ? (k.isMac && (b = b.replace("CMD", "âŒ˜").replace("SHIFT", "â‡§")), " (" + (b = b.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")) + ")") : ""
                };
            this.initialize = function() {
        ...
        ka = function(b) {
            ...
            this.createShortCutList = function() {
                ...
                var b = f.dialogsInBody ? a(document.body) : e,
                    c = ['<p class="text-center">', '<a href="http://summernote.org/" target="_blank">Summernote 0.8.8</a> Â· ', '<a href="https://github.com/summernote/summernote" target="_blank">Project</a> Â· ', '<a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
                this.$dialog = d.dialog({
